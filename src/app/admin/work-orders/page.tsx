            ...
            <tbody className="divide-y divide-gray-100">
              {currentOrders.map((order, i) => (
                <tr key={i} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-6">
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full ${order.statusBg} ${order.statusColor} text-[10px] font-bold tracking-widest uppercase`}>
